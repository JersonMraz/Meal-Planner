        ...
        <div className="mx-auto flex max-w-6xl flex-col-reverse md:flex-row items-center gap-10 px-4 py-16 md:py-24">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-elevated">
              <Image src={heroImg} loading="eager" alt="Delicious food spread" className="w-full aspect-4/3 object-cover" />
        ...
        >
          ...
          <Button size="lg" variant="secondary" asChild>
            <Link href={isLoggedIn ? "/dashboard" : "/signup"}>
              {isLoggedIn ? "Go to Dashboard" : "Get Started — It's Free"} <ArrowRight className="ml-1 h-4 w-4" />
            </Link>
          </Button>
        </motion.div>
      </section>
